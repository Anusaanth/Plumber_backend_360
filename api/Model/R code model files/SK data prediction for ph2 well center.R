...
cartofact_data_extracting_path <- file.path(current_directory,'api','Model','Python file for Cartofact data extracting','extracting cartofact attributes sk.py')
...
write.csv(Pred_result_SK_ph2W1.1, file = 'SK_pred_result1.1.csv', row.names = FALSE)
